         ...
         <div className="bg-slate-900 rounded-[2.5rem] p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
               ...
               <p className="text-slate-400 text-lg mb-8">
                  Rejoignez les praticiens qui ont choisi la sérénité. Essai gratuit, sans engagement.
               </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-2">
             ...
             <p className="text-slate-500 max-w-sm mb-8 leading-relaxed">
                L'intelligence artificielle au service de la santé. Nous redonnons du temps aux praticiens pour ce qui compte vraiment : les soins.
             </p>
